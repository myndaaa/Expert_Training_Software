	...
	<?php
		...
		<div class="header">
			<div class="header-container">
				...
				<a href = "eprofile.php?employeeID=<?php echo $employeeID; ?>"><img src="images/profile3.png" alt=""></a><span>-----</span>
				<a href = "message.php?employeeID=<?php echo $employeeID; ?>"><img src="images/message.png" alt=""></a><span>-----</span>
				<a href = "enotification.php?employeeID=<?php echo $employeeID; ?>"><img src="images/notification.png" alt=""></a></h3>
				<style>
				span{
				color: #2F455C;
				}
...
#firstname {
  ...
  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);
		...
		<div class="container">
			...
			<a href = "employee_ws_mgt.php?employeeID=<?php echo $employeeID; ?>">					
				<div class="box left-box"><h2>Workshop Management</h2> </div>					
			</a>
		</div>
