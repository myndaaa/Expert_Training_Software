...
$sql = "SELECT * FROM login_employee WHERE username='$uname' AND email='$email'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) == 1) {
  // If the combination exists, update the password in the table
  $sql_update = "UPDATE login_employee SET password='$npassword' WHERE username='$uname' AND email='$email'";
...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<div class="card">
				<h2>Return to <a href = "login_employee.php">log in</a> </h2>
			</div>
